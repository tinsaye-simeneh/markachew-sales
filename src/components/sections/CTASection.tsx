    ...
    <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-blue-600 to-blue-700">
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-purple-600 to-purple-700">
            <CardContent className="p-8 text-center text-white">
              <div className="inline-flex p-4 rounded-full bg-white/20 backdrop-blur-sm mb-6">
              ...
              <Button 
                size="lg" 
                className="bg-white text-purple-600 hover:bg-gray-100 group-hover:scale-105 transition-transform"
              >
                Find Jobs
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
